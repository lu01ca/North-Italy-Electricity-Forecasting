...
### Calendar Effect (Festività separate e no feature ridondanti) ###
...
### Creation of 24 target variables (Previsioni da t+1 a t+24) ###
for i in range(1, 25):
...
print("MODELS COMPARISIONS")
print(f"Total parameters LSTM : {params_lstm:,}")
print(f"Totale parameters GRU  : {params_gru:,}")
